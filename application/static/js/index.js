...
function getResult(obj) {
    ...
    for (let i in obj.result) {
        ...
        '<td class="text-center">'+ obj.result[i].x_min +'</td>' +
        '<td class="text-center">'+ obj.result[i].x_max +'</td>' +
        '<td class="text-center">'+ obj.result[i].y_min +'</td>' +
        '<td class="text-center">'+ obj.result[i].y_max +'</td>' +
